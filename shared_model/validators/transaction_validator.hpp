  ...
  namespace validation {
    ...
    class TransactionValidator {
     public:
       ...
       */
      Answer validate(
          const detail::PolymorphicWrapper<interface::Transaction> &tx) const {
