...
namespace iroha {
  namespace ametsuchi {
    ...
    bool MutableStorageImpl::apply(
      ...
      std::shared_ptr<model::Block> block(new_block.makeOldModel()); // TODO remove in shared_model
      ...
      shared_model::crypto::Hash new_hash({top_hash_.begin(), top_hash_.end()}); // TODO replace with shared_model
